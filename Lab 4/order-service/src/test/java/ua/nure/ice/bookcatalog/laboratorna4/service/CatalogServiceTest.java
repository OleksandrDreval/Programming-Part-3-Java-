...
import ua.nure.ice.bookcatalog.laboratorna4.exception.BookNotFoundException;
import ua.nure.ice.bookcatalog.laboratorna4.exception.DuplicateBookException;
import ua.nure.ice.bookcatalog.laboratorna4.exception.InvalidBookDataException;
...
class CatalogServiceTest {
    ...
    @BeforeEach
    void setUp() {
        validBook = new Book(1L, "Test Title", "Test Author", 2023, BookGenre.FICTION, new BigDecimal("350.00"));
    }
    ...
    void addBook_valid_success() {
        ...
        Book saved = catalogService.addBook("Test Title", "Test Author", 2023, BookGenre.FICTION, new BigDecimal("350.00"));
        assertNotNull(saved);
    ...
    void addBook_duplicate_throwsException() {
        ...
        assertThrows(DuplicateBookException.class, () -> catalogService.addBook("Test Title", "Test Author", 2023, BookGenre.FICTION, new BigDecimal("350.00")));
    }

    @Test
    void addBook_invalidInput_throwsException() {
        assertThrows(InvalidBookDataException.class, () -> catalogService.addBook(null, "Author", 2023, BookGenre.FICTION, new BigDecimal("350.00")));
        assertThrows(InvalidBookDataException.class, () -> catalogService.addBook("", "Author", 2023, BookGenre.FICTION, new BigDecimal("350.00")));
        assertThrows(InvalidBookDataException.class, () -> catalogService.addBook("Title", null, 2023, BookGenre.FICTION, new BigDecimal("350.00")));
        assertThrows(InvalidBookDataException.class, () -> catalogService.addBook("Title", "", 2023, BookGenre.FICTION, new BigDecimal("350.00")));
        assertThrows(InvalidBookDataException.class, () -> catalogService.addBook("Title", "Author", 2023, null, new BigDecimal("350.00")));
        assertThrows(InvalidBookDataException.class, () -> catalogService.addBook("Title", "Author", 0, BookGenre.FICTION, new BigDecimal("350.00")));
        assertThrows(InvalidBookDataException.class, () -> catalogService.addBook("Title", "Author", 2023, BookGenre.FICTION, new BigDecimal("-10.00")));
    }
    ...
    void addBook_illegalArgumentFromBook_throwsException() {
        ...
        assertThrows(InvalidBookDataException.class, () -> catalogService.addBook("Title", "Author", 1000, BookGenre.FICTION, new BigDecimal("350.00")));
    }
    ...
    void updateBook_success() {
        ...
        Book updated = catalogService.updateBook(1L, "New Title", "New Author", 2024, BookGenre.SCIENCE_FICTION, new BigDecimal("400.00"));
    ...
    void updateBook_notFound_throwsException() {
        ...
        assertThrows(BookNotFoundException.class, () -> catalogService.updateBook(1L, "Title", "Author", 2024, BookGenre.FICTION, new BigDecimal("400.00")));
    }

    @Test
    void updateBook_duplicate_throwsException() {
        Book otherBook = new Book(2L, "New Title", "New Author", 2024, BookGenre.FICTION, new BigDecimal("400.00"));
        when(bookRepository.findById(1L)).thenReturn(Optional.of(validBook));
        when(bookRepository.findDuplicate("New Title", "New Author", 2024)).thenReturn(Optional.of(otherBook));

        assertThrows(DuplicateBookException.class, () -> catalogService.updateBook(1L, "New Title", "New Author", 2024, BookGenre.FICTION, new BigDecimal("400.00")));
    }
