...
class BookTest {
  ...
  void withIdShouldReturnCopyWithNewId() {
    Book book = new Book("Dune", "Frank Herbert", 1965, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00"));
  ...
  void constructorShouldThrowWhenIdIsNegative() {
    assertThrows(IllegalArgumentException.class,
        () -> new Book(-1L, "Dune", "Frank Herbert", 1965, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00")));
  }

  @Test
  void constructorShouldThrowWhenTitleIsBlank() {
    assertThrows(IllegalArgumentException.class,
        () -> new Book(" ", "Frank Herbert", 1965, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00")));
  }

  @Test
  void constructorShouldThrowWhenTitleIsNull() {
    assertThrows(IllegalArgumentException.class,
        () -> new Book(null, "Frank Herbert", 1965, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00")));
  }

  @Test
  void constructorShouldThrowWhenAuthorIsBlank() {
    assertThrows(IllegalArgumentException.class,
        () -> new Book("Dune", " ", 1965, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00")));
  }

  @Test
  void constructorShouldThrowWhenAuthorIsNull() {
    assertThrows(IllegalArgumentException.class,
        () -> new Book("Dune", null, 1965, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00")));
  }

  @Test
  void constructorShouldThrowWhenGenreIsNull() {
    assertThrows(NullPointerException.class,
        () -> new Book("Dune", "Frank Herbert", 1965, null, new BigDecimal("350.00")));
  }

  @Test
  void constructorShouldThrowWhenYearTooSmall() {
    assertThrows(IllegalArgumentException.class,
        () -> new Book("Dune", "Frank Herbert", 1400, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00")));
  }

  @Test
  void constructorShouldThrowWhenYearTooLarge() {
    assertThrows(IllegalArgumentException.class,
        () -> new Book("Dune", "Frank Herbert", 3000, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00")));
  }
  
  @Test
  void toStringShouldContainAllFields() {
    Book book = new Book(1L, "Dune", "Frank Herbert", 1965, BookGenre.SCIENCE_FICTION, new BigDecimal("350.00"));
