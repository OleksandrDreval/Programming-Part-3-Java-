...
class OrderServiceTest {
    ...
    @BeforeEach
    void setUp() {
        testBook = new Book(1L, "Test Title", "Test Author", 2023, BookGenre.FICTION, new BigDecimal("350.00"));
    ...
    void createOrder_ShouldNotThrowException_WhenPreviousOrderHasDifferentBooks() {
        Book testBook2 = new Book(2L, "Different Title", "Different Author", 2024, BookGenre.FANTASY, new BigDecimal("400.00"));
