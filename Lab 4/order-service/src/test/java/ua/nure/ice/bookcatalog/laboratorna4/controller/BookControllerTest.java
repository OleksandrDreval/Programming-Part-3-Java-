...
import ua.nure.ice.bookcatalog.laboratorna4.service.CatalogService;
...
class BookControllerTest {
    ...
    void createBook_valid_returnsCreated() throws Exception {
        when(catalogService.addBook(anyString(), anyString(), anyInt(), any(BookGenre.class), any(BigDecimal.class))).thenReturn(validBook);
    ...
    void createBook_invalid_returnsBadRequest() throws Exception {
        when(catalogService.addBook(anyString(), anyString(), anyInt(), any(BookGenre.class), any(BigDecimal.class)))
    ...
    void updateBook_success_returnsOk() throws Exception {
        when(catalogService.updateBook(anyLong(), anyString(), anyString(), anyInt(), any(BookGenre.class), any(BigDecimal.class)))
