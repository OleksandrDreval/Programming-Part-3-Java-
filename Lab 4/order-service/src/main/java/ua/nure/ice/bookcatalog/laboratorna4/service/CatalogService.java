...
public class CatalogService {
  ...
  @Transactional
  public Book addBook(String title, String author, int publicationYear, BookGenre genre, BigDecimal price) {
    validateBookInput(title, author, publicationYear, genre, price);
    ...
    try {
      Book newBook = new Book(title, author, publicationYear, genre, price);
  ...
  @Transactional
  public Book updateBook(long id, String title, String author, int publicationYear, BookGenre genre, BigDecimal price) {
    validateBookInput(title, author, publicationYear, genre, price);
  ...
  private void validateBookInput(String title, String author, int publicationYear, BookGenre genre, BigDecimal price) {
    ...
    if (price == null || price.compareTo(BigDecimal.ZERO) < 0) {
      throw new InvalidBookDataException("Price must not be null or negative.");
    }
  }
}
